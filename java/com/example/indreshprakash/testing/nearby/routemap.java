...
public class routemap extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        super.onCreate(savedInstanceState);
        View view = inflater.inflate(R.layout.activity_routemap, null);
      ...
      if (!Places.isInitialized()) {
            Places.initialize(getContext(), "AIzaSyDj7tsamDRSPDDRYsra-m9oxJzsv2Nzr7I");
        }
...
// Create a new Places client instance.
    ...
    */
    ...
    private final int FASTEST_INTERVAL = 19000;
