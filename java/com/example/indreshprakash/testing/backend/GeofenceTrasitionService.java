...
// Create a detail message with Geofences received
   ...
   /* private void sendNotification( String msg ) {
    ...
    private void sendNotification(String notificationDetails) {
        ...
        Intent notificationIntent = new Intent(getApplicationContext(), com.example.indreshprakash.testing.backend.MainActivity.class);

        // Construct a task stack.
        TaskStackBuilder stackBuilder = TaskStackBuilder.create(this);

        // Add the main Activity to the task stack as the parent.
        stackBuilder.addParentStack(com.example.indreshprakash.testing.backend.MainActivity.class);
