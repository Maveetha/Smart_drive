...
public class admin extends AppCompatActivity
    ...
    private void userdata(){
        ...
        addblackbase register=new addblackbase(addid,lat,lon);
        mregister.child(addid).setValue(register);
        LatLng addlatlng = new LatLng(lat,lon);
        createGeofence(addlatlng,500);
        Toast.makeText(this, "Black Spot added to database!", Toast.LENGTH_SHORT).show();
    }
    ...
    private void collectlatlon1(Map<String,Object> blackspot) {
        ...
        for (Map.Entry<String, Object> entry : blackspot.entrySet()) {
            ...
            for (i=0;i<count;i++) {
                ...
                if(remlat.equals(addlatit) && remlog.equals(addlogit))
                {
                    ...
                    Query applesQuery = ref.child("blackspot").orderByChild("latitude").equalTo(remlat);
                    ...
                    Query applesQuery1 = ref.child("blackspot").orderByChild("latitude").equalTo(remlog);
